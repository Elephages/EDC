var loomians = {
  ...
  fowlous: {
    ...
    bombossic: {
        ...
        abilities: ["Thermal Power"],
        sAbility: ["Victory Lap"],
		ult: ["Burning Bite", "Wheel of Fire", 170],
        finalEvo: true,
        weight: 39,
        height: 59,
        baseStats: {
...
var abilities = [
    "Abrasive", "Agile", "Altruistic", "Appeal", "Apathy", "Ashfall", "Prioritize", "Airborne", "Blood Drinker", "Last Stand", "Oblivious", "Snatcher", "Sweet Dreams", "Spectrum Plate", "Weasel Out", "Plated Armor", "Incendiary",
	...
	"Cleaner", "Crystal Clear", "Detox", "Dirty Fighter", "Emergency Rations", "Foresight", "Aromatic", "Firepower", "Readjust", "Tread Lightly", "Ricochet", "Rainfall", 
